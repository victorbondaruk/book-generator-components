    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                name: 'filter',
                description:
                    'Filter to apply to Vectara metadata. Refer to the <a target="_blank" href="https://docs.destacable.com/vector-stores/vectara">documentation</a> on how to use Vectara filters with BookGenerator.',
                type: 'string',
        ...
        async upsert(nodeData: INodeData, options: ICommonObject): Promise<Partial<IndexingResult>> {
            ...
            if (fileBase64.startsWith('FILE-STORAGE::')) {
                ...
                for (const file of files) {
                    ...
                    const blob = new Blob([bf as unknown as BlobPart])
                    vectaraFiles.push({ blob: blob, fileName: getFileName(file) })
                }
            }
