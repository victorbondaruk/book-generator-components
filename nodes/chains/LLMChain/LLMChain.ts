...
class LLMChain_Chains implements INode {
    ...
    async init(nodeData: INodeData, input: string, options: ICommonObject): Promise<any> {
        ...
        if (output === this.name) {
             ...
             * FROM: hello i am ben\n\n\thow are you?
             * TO: hello i am benBOOK_GENERATOR_NEWLINEBOOK_GENERATOR_NEWLINEBOOK_GENERATOR_TABhow are you?
             */
...
const runPrediction = async (
     ...
     * FROM: { "value": "hello i am benBOOK_GENERATOR_NEWLINEBOOK_GENERATOR_NEWLINEBOOK_GENERATOR_TABhow are you?" }
