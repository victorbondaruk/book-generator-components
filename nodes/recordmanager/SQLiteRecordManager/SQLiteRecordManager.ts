...
class SQLiteRecordManager_RecordManager implements INode {
    ...
    constructor() {
        ...
        this.inputs = [
            /*{
                ...
                type: 'string',
                placeholder: 'C:\\Users\\User\\.book-generator\\database.sqlite'
            },*/
            {
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const database = path.join(process.env.DATABASE_PATH ?? path.join(getUserHome(), '.book-generator'), 'database.sqlite')
