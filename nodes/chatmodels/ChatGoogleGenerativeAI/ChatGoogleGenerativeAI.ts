...
import { ChatGoogleGenerativeAI, GoogleGenerativeAIChatInput } from './BookGeneratorChatGoogleGenerativeAI'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description:
                    'Allow image input. Refer to the <a href="https://docs.destacable.com/using-book-generator/uploads#image" target="_blank">docs</a> for more details.',
                default: false,
                optional: true
            }
        ]
