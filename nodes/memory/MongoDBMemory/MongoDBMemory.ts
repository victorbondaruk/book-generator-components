...
import { BookGeneratorMemory, ICommonObject, IMessage, INode, INodeData, INodeParams, MemoryMethods, MessageType } from '../../../src/Interface'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.destacable.com/memory/long-term-memory#ui-and-embedded-chat">more</a>',
                default: '',
...
const initializeMongoDB = async (nodeData: INodeData, options: ICommonObject): Promise<BufferMemory> => {
    ...
    const driverInfo = { name: 'BookGenerator', version: (await getVersion()).version }
...
class BufferMemoryExtended extends BookGeneratorMemory implements MemoryMethods {
    sessionId = ''
    orgId = ''
    mongoConnection: {
        databaseName: string
