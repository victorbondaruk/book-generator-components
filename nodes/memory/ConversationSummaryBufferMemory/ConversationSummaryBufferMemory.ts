import {
    ...
    MemoryMethods,
    ICommonObject,
    BookGeneratorSummaryBufferMemory
} from '../../../src/Interface'
...
import { ChatAnthropic } from '../../chatmodels/ChatAnthropic/BookGeneratorChatAnthropic'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.destacable.com/memory#ui-and-embedded-chat">more</a>',
                default: '',
                optional: true,
...
class ConversationSummaryBufferMemoryExtended extends BookGeneratorSummaryBufferMemory implements MemoryMethods {
    appDataSource: DataSource
    databaseEntities: IDatabaseEntity
    chatflowid: string
    orgId: string
